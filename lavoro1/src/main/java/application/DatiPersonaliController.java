...
public class DatiPersonaliController {
    ...
    public void confermaPrenotazione(ActionEvent event) {
        ...
        String prenotazione = String.format("%s %s - %s ➜ %s | %s | %s € | Tel: %s | Email: %s",
                nome, cognome, volo.getPartenza(), volo.getDestinazione(),
                volo.getData(), volo.getPrezzo(), telefono, email);
        ...
        try {
            ...
            stage.setTitle("Air France - Prenotazione Confermata");
            stage.show();
